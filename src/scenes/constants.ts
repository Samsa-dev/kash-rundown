...
export const ROAD_L_BOT = SIDE_W + SWALK_W;       // 60
export const ROAD_R_BOT = W - SIDE_W - SWALK_W;   // 330
export const ROAD_L_HOR = W / 2 - 60;             // 135
export const ROAD_R_HOR = W / 2 + 60;             // 255
